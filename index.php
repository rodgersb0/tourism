...
<!-- gallery-->
    <div class="banner">
        <section>
            ...
            <div class="carousel slide" id="screenshot-carousel" data-ride="carousel" data-interval="2000">
                ...
                <div class="carousel-inner">
					...
					<div class="item active">
                        <img src="slider/18.jpg" alt="Text of the image">
                        <div class="carousel-caption">
                            <h3><strong>Kaya Mawa, Likoma Island</strong></h3>
                            <p><strong>One of the most beautiful and expensive place in Malawi, best for honeymoon vacation or aniversally</strong></p>
                        </div>
                    </div>

					
					<div class="item">
                        <img src="slider/16.jpg" alt="Text of the image">
                        <div class="carousel-caption">
                            <h3><strong>Kaya Mawa</strong></h3>
                            <p><strong>This place is on an Island known as LIkoma ISland</strong></p>
                        </div>
                    </div>

					
					<div class="item">
                        <img src="slider/17.jpg" alt="Text of the image">
                        <div class="carousel-caption">
                            <h3><strong>Kaya Mawa</strong></h3>
                            <p><strong>Wat a beautiful place, sleep close to water and experience the feeling</strong></p>
                        </div>
                    </div>
...
{	?>
			<div class="rom-btm">
				...
				<p><h5>From</h5><h4>$<?php echo htmlentities($result->PackagePrice);?></h4><h5>pp</h5></p>
